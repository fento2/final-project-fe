...
export interface DotsProps extends SpinnerProps {
...
// Spinner Components
// --------------------
export const Spinner: React.FC<SpinnerProps> = ({ size = "md", color = "slate" }) => (
...
export const RoundSpinner: React.FC<SpinnerProps> = ({ size = "md", color = "slate" }) => (
  <div aria-label="Loading..." role="status">
    <svg
      className={cn(
        "animate-spin",
...
// Dots Wrapper
// --------------------
export const Dots: React.FC<DotsProps> = ({ variant = "v1", ...props }) => {
  switch (variant) {
    case "v1":
...
// Dots Variants
// --------------------
export const Dots_v1: React.FC<SpinnerProps> = () => (
  <div className="w-fit">
...
export const Dots_v2: React.FC<SpinnerProps> = () => (
...
export const Dots_v3: React.FC<SpinnerProps> = () => (
...
export const Dots_v4: React.FC<SpinnerProps> = () => (
  <div className="flex items-center justify-center space-x-2">
    {[...Array(3)].map((_, index) => (
      <motion.span
        key={index}
...
export const Dots_v5: React.FC<SpinnerProps> = () => {
  const dots = 8;
  const radius = 24;
