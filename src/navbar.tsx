	...
	return (
		<nav className="w-full bg-transparent py-6">
			<div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
				...
				<div className="flex items-center gap-4">
					<button className="hidden md:inline-block px-5 py-2 border border-[#4F46E5] text-[#4F46E5] rounded-lg font-medium hover:bg-[#4F46E5] hover:text-white transition">Sign In</button>
